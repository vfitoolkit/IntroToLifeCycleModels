%% Life-Cycle Model 9: Idiosyncratic shocks again, Idiosyncratic shocks again, Permanent (unit root) shocks
...
% You could make the transition probabilities normally distributed with a little extra effort.
