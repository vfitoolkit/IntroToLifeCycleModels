function F=LifeCycleModel49_ReturnFn(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j,alpha_i,warmglow1,warmglow2,warmglow3,beta,sj)
% Only change from LifeCycleModel45_ReturnFn is alpha_i

F=-Inf;
if agej<Jr % If working age
    c=w*kappa_j*alpha_i*z*h+(1+r)*a-aprime; % Add z here
else % Retirement
