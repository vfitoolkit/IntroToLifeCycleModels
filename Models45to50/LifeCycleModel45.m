...
% There is one change to life-cycle model 9, namely we use a different
% initial, age j=1, distribution of agents. This is partly because
% it was previously a singular mass, which is not nice for doing statistics
% with, and also because we want to parameterize and estimate later
% in Life-Cycle Model 46.
...
ReturnFn=@(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j,wg1,wg2,wg3,beta,sj) LifeCycleModel45_ReturnFn(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j,wg1,wg2,wg3,beta,sj)
