...
\end{eqnarray*}
Note that, e.g., the zero return of $a_2$ is implicit in the period 2 state 1 budget constraint (you could write it explicity as $0 *a_2$). The Lagrangian is,
\begin{eqnarray*}
