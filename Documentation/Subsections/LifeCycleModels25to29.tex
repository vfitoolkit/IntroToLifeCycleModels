...
\subsection{Life-Cycle model 26: Earnings Dynamics (Gaussian-Mixtures)}
...
\subsection{Life-Cycle model 27: Two decision variables (dual-earner household)}
...
\subsection{Life-Cycle model 28: Semi-exogenous state (fertility and children)}
