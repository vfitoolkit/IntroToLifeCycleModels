%% Life-Cycle Model 35Balt: Portfolio-Choice with Housing
...
Params.rho_u=0; % Asset return risk component is modeled as iid (if you regress, e.g., the percent change in S&P500 on it's one year lag you get a coefficient of essentially zero)
