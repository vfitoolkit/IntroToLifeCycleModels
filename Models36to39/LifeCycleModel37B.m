%% Life-Cycle Model 37B: Temptation and Self-Control, Gul-Pesendorfer preferences with Endogenous Labor
% With endogenous labor supply (based on Life-Cycle Model 9 instead of 10)
...
vfoptions.temptationFn=@(h,aprime,a,z,w,sigmatempt,scaletemptation,agej,Jr,pension,r,kappa_j) LifeCycleModel37B_TemptationFn(h,aprime,a,z,w,sigmatempt,scaletemptation,agej,Jr,pension,r,kappa_j);

%% Now, create the return function 
DiscountFactorParamNames={'beta','sj'};

% LifeCycleModel37B_ReturnFn is essentially just LifeCycleModel9_ReturnFn without the warm-glow
ReturnFn=@(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j) ...
    LifeCycleModel37B_ReturnFn(h,aprime,a,z,w,sigma,psi,eta,agej,Jr,pension,r,kappa_j);
