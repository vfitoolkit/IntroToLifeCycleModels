%% Life-Cycle Model 26: Earnings Dynamics (Gaussian-Mixtures)
...
% Use 'LifeCycleModel26_ReturnFn', and now input z, upsilon and e.
ReturnFn=@(aprime,a,z1,upsilon,e,alpha,w,sigma,agej,Jr,pension,incomefloor,r,kappa_j,wg1,wg2,wg3,beta,sj,tau1,tau2,Jbeq)...
    LifeCycleModel26_ReturnFn(aprime,a,z1,upsilon,e,alpha,w,sigma,agej,Jr,pension,incomefloor,r,kappa_j,wg1,wg2,wg3,beta,sj,tau1,tau2,Jbeq);
