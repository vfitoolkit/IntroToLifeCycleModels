...
n_z=21; % Exogenous 'unemplolyment' shock
...
Params.sigma2 = 0.5; % Substitution between consumption and leisure
Params.sigma3 = 2; % Curvature of utility
% Note: I have not thought seriously about appropriate parameter values for sigma1, sigma2, and sigma3. These are very arbitrary
...
Params.warmglow3=2; % By using the same curvature as the utility of consumption it makes it much easier to guess appropraite parameter values for the warm glow
...
ReturnFn=@(h,aprime,a,z,w,sigma1,sigma2,sigma3,agej,Jr,pension,r,kappa_j,warmglow1,warmglow2,warmglow3,beta,sj) Assignment2_ReturnFn(h,aprime,a,z,w,sigma1,sigma2,sigma3,agej,Jr,pension,r,kappa_j,warmglow1,warmglow2,warmglow3,beta,sj)
