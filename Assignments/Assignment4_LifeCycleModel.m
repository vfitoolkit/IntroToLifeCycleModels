...
% There are essentially three changes involved: the discount factor and the budget constraint.
...
Params.growthdiscount=(1+Params.g)^(1-Params.sigma);
DiscountFactorParamNames={'beta','sj','growthdiscount'};

% Switch to use 'LifeCycleModel10_ReturnFn'
ReturnFn=@(aprime,a,z,w,sigma,agej,Jr,pension,r,kappa_j,warmglow1,warmglow2,warmglow3,beta,sj,g) Assignment4_ReturnFn(aprime,a,z,w,sigma,agej,Jr,pension,r,kappa_j,warmglow1,warmglow2,warmglow3,beta,sj,g)
...
FnsToEvaluate.earningshat=@(aprime,a,z,w,kappa_j) w*kappa_j*z; % z is the 'stochastic endowment' or 'exogenous earnings'
FnsToEvaluate.ahat=@(aprime,a,z) a; % a is the current asset holdings
